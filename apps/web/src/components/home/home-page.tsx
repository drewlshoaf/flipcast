...
const EXPLAINERS = [
  ...
  {
    label: "Made for you",
    body: "Every Flipcast is produced on demand, about what you said.",
    chip: "chip-slate",
  },
];
    ...
    <div className="mx-auto max-w-[1200px] px-6 py-6 md:px-10">
      ...
      <section className="mb-16 grid grid-cols-1 items-start gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
        <div>
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-ink-500">
            ...
            Flipcast produces a ~7 minute episode you can play right now.
          </p>
      ...
      <section className="mb-16">
        <div className="mb-6">
          ...
          <p className="mt-2 text-base text-ink-500">
            Four ways Flipcast is built for fast, joyful creation.
          </p>
        </div>
      ...
      <footer className="border-t border-slate-200/70 pt-6 text-xs text-ink-400">
        <span>Flipcast — on-demand podcasts, one topic at a time.</span>
      </footer>
    </div>
  );
}
